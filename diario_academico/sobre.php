...
<body>
  ...
  <main>
    ...
    <h1 class="principal">Sobre o SIDA</h1>
          ...
          <div class="carousel-item slidesA">
            ...
            <div class="sobreCorpo">
              <p class="sobreParagrafos"> Поклонник онлайн-игр.
                <br>“Не создавайте себе ограничений. Вы должны зайти так далеко, насколько позволяет ваш разум. То, чего вы хотите больше всего, может быть достигнуто." – Mary Kay Ash
              </p>
      ...
      <div id="carouselExampleIndicatorsI" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner slidesI">
          <div class="carousel-item active">
            ...
            <div class="sobreCorpo">
              <p class="sobreParagrafos">
                “And I knew exactly what to do. But in a much more real sense, I had no idea what to do.”<br>
                Michael Scott
              </p>
